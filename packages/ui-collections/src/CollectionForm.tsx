  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        // A PK is only "system-managed" when the database or DaaS generates
        // its value (auto-increment integer/bigint, or a generated uuid).
        // A manually-entered string/int PK requires the user to type a
        // value, so it must stay visible, writable, and part of the payload.
